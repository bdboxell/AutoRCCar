...
class Tetromino:
    ...
    '''
    def __init__(self, frame, unit_length, type, orientation, coords, color):
        self.type = type
    ...
    def draw(self):
        for cell in self.occupied_cells:
            ...
            center = Math_Utils.Vector(cell[0] + self.unit_length/2, cell[1] + self.unit_length/2)
            # center.print()
            ...
            Graphics.fill_rect(self.frame, self.color, center, (self.unit_length,self.unit_length))
